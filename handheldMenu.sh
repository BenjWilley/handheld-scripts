...
meshtastic --set canned_message.inputbroker_pin_a 3
meshtastic --set canned_message.inputbroker_pin_b 2
meshtastic --set canned_message.inputbroker_pin_press 1
